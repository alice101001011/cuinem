        ...
        response.data.forEach((recipe) => {
          container.innerHTML += `  
            ...
            <div class="card-links">
                <div>
                    <a href="/community-recipes/${recipe._id}}" type="button" class="btn btn-sm btn-outline-dark"><i class="bi-eye-fill" style="font-size: 1rem; color: cornflowerblue;"></i> View</a>
                </div>
                <div>
                    <a href="/community-recipes/${recipe._id}}/edit" type="button"
                        class="btn btn-sm btn-outline-dark"><i class="bi-pencil-fill" style="font-size: 1rem; color: cornflowerblue;"></i> Edit</a>
                </div>
                <div>
                        <button type="submit" class="btn btn-sm btn-outline-dark delete-recipe-button"><i class="bi-trash-fill" style="font-size: 1rem; color: red;"></i> Delete<span hidden>${recipe._id}</span></button>
                </div>
            </div>
        </div>
